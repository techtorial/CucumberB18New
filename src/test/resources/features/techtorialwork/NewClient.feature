...
Feature: Testing New Client Create,Search and Order Functionality
  ...
  Scenario: Happy Path create functionality for new client
    ...
    And User clicks add client and provides 'John Doe', 'john.doe@example.com','United States','3147353233' for ClientPage
    ...
    Then User clicks save button and validates 'John Doe','Doe Construction Inc.','john.doe@example.com','Active' from table.
